...
const ProductSelector: React.FC<ProductSelectorProps> = ({ products, onSelect, onAddOwnProductClick }) => {
 ...
 className="absolute -left-4 z-10 p-2 bg-white dp-radius hover:bg-navy-50/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 ...
 className="absolute -right-4 z-10 p-2 bg-white dp-radius hover:bg-navy-50/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 ...
 className="bg-white dp-navy transition-transform hover:-translate-y-[1px] border border-navy-200 dp-radius dp-btn-text h-12"
 >
